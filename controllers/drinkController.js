const Drink = require("../models/Drink");    //holds routing and method
...
module.exports = {
    ...
    updateDrink: (req, res) => {
        Drink.findByIdAndUpdate({_id: req.params.id}, req.body, {new: true, 
        runValidators: true})
    ...
    deleteDrink: (req, res) => {
        Drink.findByIdAndDelete({_id: res.params.id })
